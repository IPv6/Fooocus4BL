...
def worker():
    ...
    def apply_control_nets(async_task, height, ip_adapter_face_path, ip_adapter_path, width, current_progress):
        ...
        for cn_flag in (flags.cn_adepthF, flags.cn_arecolor, flags.cn_alightQ, flags.cn_ashapeC, flags.cn_acanny, flags.cn_alineA):
    ...
    def handler(async_task: AsyncTask):
        ...
        pipeline.refresh_controlnets([controlnet_canny_path, controlnet_cpds_path] + [async_task.controlnet_adepthF_path, async_task.controlnet_arecolor_path, async_task.controlnet_alightQ_path, async_task.controlnet_ashapeC_path, async_task.controlnet_acanny_path, async_task.controlnet_alineA_path]) # Fooocus4BL: refreshing with extra-CNs
